...
def add_node(tree, patient_history):
    position = root(tree)
    for treatment_line, treat_counter in patient_history:
        if treatmentline exists at root: 
            increase number by 1
        else: 
            create new node with the treatment_line and value of 1
        # counter is increased by 1 and we move on 
