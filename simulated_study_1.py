...
plt.plot([0,N_patients/3-1], [1,1], color='k', marker='', linestyle='-', linewidth=1, label="Truth", zorder=5)
plt.plot([N_patients/3, 2/3*N_patients-1], [0.1,0.1], color='k', marker='', linestyle='-', linewidth=1, zorder=5)
plt.plot([2/3*N_patients, N_patients-1], [0,0], color='k', marker='', linestyle='-', linewidth=1, zorder=5)
