...
def sample_from_BNN_model_advi(X, patient_dictionary, name, N_samples=5000, N_advi=500000, target_accept=0.99, max_treedepth=10, psi_prior="lognormal", FUNNEL_REPARAMETRIZATION=False, FUNNEL_WEIGHTS = False):
